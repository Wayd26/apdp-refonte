                    ...
                    <div className="header-block-2">
                        ...
                        {/* </a> */}
                            ...
                            <div className=" d-none d-md-flex header-block-2-div-2 d-flex flex-row justify-content-around">
                                ...
                                <div className="col" style={{color: "#292929", font: "normal normal normal 15px/35px Monsterrat", cursor: "pointer", width: 'fit-content', flex: 'none', padding: '20px'}}> 
                                    <a className="code_numerique" target={"_blank"} href={code_numerique} rel={"noopener noreferer"} > CODE DU NUMERIQUE </a> 
                                </div>
                                <div className="col" style={{color: "#292929", font: "normal normal normal 15px/35px Monsterrat", cursor: "pointer", width: 'fit-content', flex: 'none', padding: '20px'}} onClick={handleClickRecommandations}> RECOMMANDATIONS</div>
                                    <div    className='dropdown'
                                            onMouseLeave={() => setShowDropdownApdp(false)}
                                            onMouseOver={() => setShowDropdownApdp(true)}
                                    >
                                        <div className="dropdown-toggle drop-class" style={{ font: "normal normal normal 15px/35px Monsterrat", cursor: "pointer", width: 'fit-content', flex: 'none', padding: '20px'}}
