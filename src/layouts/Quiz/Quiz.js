...
const Quiz = () => {
    return (
        <div stylz={{background: "#F7F7F7"}}>
            <ActualiteCarousel />
            <div className="quiz-box">
            <p className="quiz-title">LES COURRIERS POUR AGIR</p>
            <p className="quiz-select-catgory-text">SÉLECTIONNER LA CATÉGORIE DE VOTRE QUESTION</p>
            <div className="quiz-category-box row d-flex justify-content-between">
            ...
            <div className="quiz-category-card-box row d-flex justify-content-between">
                <div className="col">
                    <QuizCard />
                    </div>
                <div className="col">
